...
namespace CodeChecker
{
    ...
    public sealed partial class Data
    {
        ...
        public sealed class Require
        {
            ...
            /// <summary>
            /// Throw an <see cref="NullReferenceException"/> if the value is null.
            /// </summary>
            ...
            /// <summary>
            /// Throw an <see cref="NullReferenceException"/> if the value (<see cref="string"/>) is null or empty.
            /// </summary>
            /// <param name="value">Value to be tested.</param>
            /// <param name="paramName">Name of the parameter.</param>
            /// <exception cref="NullReferenceException">.</exception>
            ...
            /// <summary>
            /// Throw an <see cref="NullReferenceException"/> if the values (<see cref="ICollection{T}"/>) is null.
            /// </summary>
            /// <typeparam name="T"><typeparamref name="T"/>.</typeparam>
            ...
            /// <summary>
            /// Throw an <see cref="NullReferenceException"/> if the values (<see cref="IEnumerable{T}"/>) is null.
            /// </summary>
            /// <typeparam name="T"><typeparamref name="T"/>.</typeparam>
            /// <param name="values">Value to be tested.</param>
            /// <exception cref="NullReferenceException">.</exception>
